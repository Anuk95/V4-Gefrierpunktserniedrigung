...
\fbox{
  ...
  $
  Literaturwerte:\\
  $M_\mathrm{Campher} = 152,23 \mathrm{g{~} mol^{-1}}
  $\\
  $M_\mathrm{KCl} = 74,55 \mathrm{g{~} mol^{-1}} 
$\\\\
...
Der Fehler $\Delta M$ lässt sich durch die Gaußsche Fehlerfortpflanzung folgendermaßen berechnen:
...
Neben den Fehlern aus der Fehlerfortpflanzung sind weitere systematische Fehler möglich, welche eine Abweichung des Wertes verursachen, jedoch quantitativ nicht messbar sind. 
